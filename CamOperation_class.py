...
class CameraOperation:
    ...
    def Save_jpg(self):
        ...
        selected_folder_path = "D:\OneDrive\Masaüstü\Mermer_Projesi_Final_Tasarim\edanaz"
        # 获取缓存锁
        self.buf_lock.acquire()

        file_name = str(self.st_frame_info.nFrameNum) + ".jpg"
    ...
    def Save_Bmp(self):
        ...
        file_name = str(self.st_frame_info.nFrameNum) + ".bmp"
        file_path = os.path.join(selected_folder_path, file_name)
        c_file_path = file_path.encode('utf-8')
    ...
    def read_selected_folder_path(self):
        try:
            self.selected_folder_path ="D:\OneDrive\Masaüstü\Mermer_Projesi_Final_Tasarim\edanaz"
        except FileNotFoundError:
            print("Error: selected_folder_path.txt not found.")
            return None
